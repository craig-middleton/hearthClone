...
_Last updated: 2026-08-18 (session 30 — `MinionView` root/`ArtworkImage` resized to 160x220 to match `CardView`; fixed board card size-mismatch bug caused by `ArtworkImage`'s fixed-size anchors not tracking the layout-group-compressed root)_
